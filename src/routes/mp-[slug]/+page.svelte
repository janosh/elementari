...
<main>
  ...
  <h3>Crystal description <small>(generated by <a href="https://github.com/hackingmaterials/robocrystallographer">Robocrystallographer</a>)</small></h3>
  ...
  <ol class="similar-structures">
    ...
    <li>
      <strong><a href="https://materialsproject.org/tasks/{task_id}">{task_id}</a></strong><span>{formula}</span>
      <br>
