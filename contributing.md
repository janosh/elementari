...
- tests: run as [GitHub Action](https://github.com/janosh/periodic-table/actions/workflows/test.yml) ([workflow code](https://github.com/janosh/periodic-table/blob/main/.github/workflows/test.yml))
- linting: handled by [pre-commit.ci](https://results.pre-commit.ci/latest/github/janosh/periodic-table/main)
- docs: [continuous deployment](https://github.com/janosh/periodic-table/blob/main/.github/workflows/gh-pages.yml) through GitHub Pages
...
Finally [publish a new release on GitHub](https://github.com/janosh/periodic-table/releases/new).
